...
namespace MeshCore
{
    ...
    public class MeshNode : IDisposable
    {
        ...
        public MeshNode(Stream s, string password, string profileFolder)
        {
            _password = password;
            _profileFolder = profileFolder;
            ...
            switch (s.ReadByte()) //version
            {
                case 1:
                    ...
                    InitMeshNode(new BinaryReader(cS), _profileFolder);
                    break;
        ...
        private void InitMeshNode(BinaryReader bR, string profileFolder)
        {
            _version = bR.ReadByte();
            switch (_version) //version
            {
                case 1:
                    ...
                    {
                        MeshNetwork network = new MeshNetwork(profileFolder, bR);
        ...
        public Dictionary<BinaryNumber, MeshNetwork> Networks
