...
namespace MeshCore.Network
{
    ...
    public class MeshNetwork : IDisposable
    {
        ...
        MeshNetworkPeerInfo[] _peersKnown;
        ...
        public MeshNetwork(string profileFolder, BinaryReader bR)
        {
            ...
            switch (bR.ReadByte()) //version
            {
                case 1:
                    ...
                    _peersKnown = knownPeers;

                    ReadMeshNetwork(profileFolder, knownPeers);
                    break;
        ...
        private void ReadMeshNetwork(string profileFolder, MeshNetworkPeerInfo[] knownPeers = null)
        {
            //init message store
            string messageStoreFolder = Path.Combine(profileFolder, "messages");
            if (!Directory.Exists(messageStoreFolder))
                Directory.CreateDirectory(messageStoreFolder);
            ...
            //load self as peer
            _selfPeer = new Peer(this, _userId, "HAHA");
        ...
        public string GetMessageStoreID()
        {
            return _messageStoreId;
        }
        ...
        public MeshNetworkPeerInfo[] PeersKnown
        { get { return _peersKnown; } }
